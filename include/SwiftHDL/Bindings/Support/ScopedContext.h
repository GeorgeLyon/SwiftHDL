#ifndef SWIFT_HDL_BINDINGS_SUPPORT_SCOPED_CONTEXT_H_
#define SWIFT_HDL_BINDINGS_SUPPORT_SCOPED_CONTEXT_H_
...
#endif // SWIFT_HDL_BINDINGS_SUPPORT_SCOPED_CONTEXT_H_
